...
class Toolbox extends Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this._isDisableToggleCamera = this._isDisableToggleCamera.bind(this);
    ...
    _renderToolboxContent() {
        const { _chatOpen, _overflowMenuVisible, _raisedHand, t } = this.props;
        ...
        return (
            <div className="toolbox-content">
             {!isMobileBrowser() &&  <div className="button-group-left">
                ...
                <div className="button-group-center">
                    ...
                    {!this._isDisableToggleCamera() && (
                        <CameraToggleButton visible={true} />
                    )}
                </div>
        {!isMobileBrowser() &&      <div className="button-group-right">
    ...
    _isDisableToggleCamera: (string) => boolean;
